...
var DES3 = {}
DES3.iv = '01234567';
DES3.k = "gagc#2017ABCDgagc#2017ABCD";
DES3.p = function(k) {
...
DES3.mode = 1;
DES3.g = function() {
	return this.p(this.k.slice(0, 24));
}
DES3.n = function() {
	return(navigator.appName == "Microsoft Internet Explorer");
}
DES3.encrypt = function(input) {
	return(this.n) ? Base64.btoa(des(this.g(), input, 1, this.mode, this.iv, 1)) : btoa(des(this.g(), input, 1, this.mode, this.iv, 1));
}
DES3.decrypt = function(input) {
	return(this.n) ? des(this.g(), Base64.atob(input), 0, this.mode, this.iv, 1) : des(this.g(), atob(input), 0, this.mode, this.iv, 1);
}